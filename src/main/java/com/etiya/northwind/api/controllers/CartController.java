...
public class CartController {
    ...
    public void addToOrder(@RequestBody @Valid CreateRequestAddToOrder createRequestAddToOrder, @RequestBody @Valid CreateRequestAddToOrderDetails createRequestAddToOrderDetails) {
        this.cartService.addToOrder(createRequestAddToOrder,createRequestAddToOrderDetails);
    }

    @DeleteMapping("/deletefromcart")
    public void deleteFromCart(@RequestBody @Valid CreateRequestAddToOrder createRequestAddToOrder){
        this.cartService.deleteFromCart(createRequestAddToOrder);
    }
