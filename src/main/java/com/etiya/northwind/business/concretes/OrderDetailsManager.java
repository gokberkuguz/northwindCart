...
public class OrderDetailsManager implements OrderDetailsService {
    ...
    public Result delete(int orderId, int productId) {
        ...
        checkIfMappedOrderDetailExists(orderDetail);
    ...
    public DataResult<OrderDetailsListResponse> getById(OrderDetailsId orderDetailsId) {
        ...
        OrderDetailsListResponse response;

        checkIfOrderDetailsIdExists(orderDetailsId);
    ...
    private void checkIfMappedOrderDetailExists(OrderDetails orderDetail){
        if (orderDetail == null) {
            throw  new BusinessException("Validation Exception");
        }
    }

    private void checkIfOrderDetailsIdExists(OrderDetailsId orderDetailsId){
        if (!this.orderDetailsRepository.existsById(orderDetailsId)){
            throw new BusinessException("Invalid OrderDetailsId");
        }
    }
}