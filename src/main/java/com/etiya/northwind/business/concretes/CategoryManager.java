...
public class CategoryManager implements CategoryService {
    ...
    public Result delete(int categoryId) {
        ...
        checkIfCategoryIdExists(categoryId);
    ...
    public DataResult<List<CategoryListResponse>> getAll() {
        ...
        List<CategoryListResponse> response =
                result.stream().map(category -> this.modelMapperService.forResponse()
    ...
    public PageDataResponse<CategoryListResponse> getByPage(int pageNumber, int categoryAmountInPage) {
        ...
        List<CategoryListResponse> response =
                pages.getContent().stream().map(category -> this.modelMapperService.forResponse()
                        .map(category, CategoryListResponse.class)).collect(Collectors.toList());
    ...
    private void checkIfCategoryIdExists(int categoryId){
        if(!this.categoryRepository.existsById(categoryId)){
